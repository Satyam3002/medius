...
export default function Mortgage() {
  ...
  const [downPayment, setDownPayment] = useState("60000"); // Default down payment
  ...
  // Recalculate monthly payment whenever input data changes
  useEffect(() => {
    calculateMonthlyPayment();
  }, [homePrice, downPayment, interestRate, loanTerm]); // Dependency array
