export default function Hero() {
    return (
      <div className="py-36 bg-customGreen">
        {/* Title Section */}
        <div className="text-6xl md:text-8xl text-textGreen font-bold flex flex-col items-center justify-center space-y-4">
          <div>Mortgages</div>
          <div>made simple</div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-around mt-16 space-y-8 md:space-y-0">
          ...
          <div className="flex flex-col space-y-2 justify-center items-center">
            ...
            <div className="flex justify-center gap-x-2 items-center text-white text-sm">
              <img src="/stopwatch.png" alt="" className="h-4 w-4" />
          ...
          <div className="flex flex-col items-center space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex space-x-1">
                ...
                <img src="/star.png" alt="" className="w-6 h-6" />
                <img src="/star.png" alt="" className="w-6 h-6" />
                <img src="/halfstar.png" alt="" className="w-6 h-6" />
              </div>
            </div>
